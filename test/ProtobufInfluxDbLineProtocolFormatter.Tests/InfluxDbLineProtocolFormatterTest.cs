...
{
    /// <summary>
    /// Tests for the InfluxDb line protocol formatter
    /// </summary>
    public class InfluxDbLineProtocolFormatterTest
    {
        private Timestamp TestTime =>
            Timestamp.FromDateTime(new DateTime(2024, 10, 11, 1, 2, 3, DateTimeKind.Utc));

        //[Test]
        //public void DefaultValues_WhenOmitted()
        //{
        //    var formatter = InfluxDbLineProtocolFormatter.Default;
        //    var tags = new HashSet<string>();
        //    AssertJson(
        //        "foreign-message",
        //        formatter.Format(new ForeignMessage(), "foreign-message", tags, TestTime)
        //    );
        //    AssertJson("{ }", formatter.Format(new TestAllTypes(), "all-types", tags, TestTime));
        //    AssertJson("{ }", formatter.Format(new TestMap(), "foreign-message", tags, TestTime));
        //}

        //[Test]
        //public void DefaultValues_WhenIncluded()
        //{
        //    var formatter = new InfluxDbLineProtocolFormatter(
        //        InfluxDbLineProtocolFormatter.Settings.Default.WithFormatDefaultValues(true)
        //    );
        ...
        //        {
        //            var message = new TestEnumAllowAlias { Value = TestEnumWithDupValue.Foo2, };
        //            var actualText = InfluxDbLineProtocolFormatter.Default.Format(message);
        ...
        //            };
        //            var formatter = new InfluxDbLineProtocolFormatter(
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithFormatEnumsAsIntegers(true)
        //            );
        //            var actualText = formatter.Format(message);
        //            var expectedText =
        //                "{ " + "'singleForeignEnum': 5, " + "'repeatedForeignEnum': [ 6, 100, 4 ]" + " }";
        //            AssertJson(expectedText, actualText);
        //        }
        ...
        public void AllSingleFields()
        {
            ...
            var tags = new HashSet<string> { "singleString" };
            var actualText = InfluxDbLineProtocolFormatter.Default.Format(
                message,
                $"{nameof(AllSingleFields).ToLower()}",
                tags,
                TestTime
            );
        ...
        //        {
        //            AssertJson(
        //                "{ 'repeatedInt32': [ 1, 2, 3, 4, 5 ] }",
        //                InfluxDbLineProtocolFormatter.Default.Format(new TestAllTypes { RepeatedInt32 = { 1, 2, 3, 4, 5 } })
        //            );
        //        }
        ...
        //        {
        //            AssertJson(
        //                "{ 'mapStringString': { 'with spaces': 'bar', 'a': 'b' } }",
        //                InfluxDbLineProtocolFormatter.Default.Format(
        //                    new TestMap { MapStringString = { { "with spaces", "bar" }, { "a", "b" } } }
        //                )
        //            );
        //        }
        ...
        //            AssertJson(
        //                "{ 'mapInt32Int32': { '0': 1, '2': 3 } }",
        //                InfluxDbLineProtocolFormatter.Default.Format(new TestMap { MapInt32Int32 = { { 0, 1 }, { 2, 3 } } })
        //            );
        //        }
        ...
        //            // The keys are quoted, but the values aren't.
        //            AssertJson(
        //                "{ 'mapBoolBool': { 'false': true, 'true': false } }",
        //                InfluxDbLineProtocolFormatter.Default.Format(
        //                    new TestMap { MapBoolBool = { { false, true }, { true, false } } }
        //                )
        //            );
        //        }
        ...
        //            AssertJson("{ 'nullValue': null }", InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }
        ...
        //            AssertJson("{ }", InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }
        ...
        //            string actualText = InfluxDbLineProtocolFormatter.Default.Format(message);
        ...
        //            AssertJson("{ 'singleForeignEnum': 100 }", InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }
        ...
        //            };
        //            AssertJson(
        //                "{ 'repeatedForeignEnum': [ 'FOREIGN_BAZ', 100, 'FOREIGN_FOO' ] }",
        //                InfluxDbLineProtocolFormatter.Default.Format(message)
        //            );
        //        }
        ...
        //            var message = new TestAllTypes
        //            {
        //                RepeatedForeignEnum = { (ForeignEnum)200, (ForeignEnum)100 }
        //            };
        //            AssertJson(
        //                "{ 'repeatedForeignEnum': [ 200, 100 ] }",
        //                InfluxDbLineProtocolFormatter.Default.Format(message)
        //            );
        //        }
        ...
        //            Assert.Throws<ArgumentException>(() => InfluxDbLineProtocolFormatter.Default.Format(message));
        ...
        //        {
        //            Assert.AreEqual(expected, InfluxDbLineProtocolFormatter.ToJsonName(original));
        //        }
        ...
        //            formatter = new InfluxDbLineProtocolFormatter(
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithFormatDefaultValues(true)
        //            );
        //            AssertJson(expectedJson, formatter.Format(message));
        //        }
        ...
        //            };
        //            var expectedJson =
        //                "{ 'int64Field': '10', 'int32Field': 0, 'stringField': '', 'bytesField': 'ABCD' }";
        //            AssertJson(expectedJson, InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }

        //        [Test]
        //        public void WrapperFormatting_Message()
        //        {
        //            Assert.AreEqual("\"\"", InfluxDbLineProtocolFormatter.Default.Format(new StringValue()));
        //            Assert.AreEqual("0", InfluxDbLineProtocolFormatter.Default.Format(new Int32Value()));
        //        }
        ...
        //            };
        //            AssertJson(
        //                "{ 'plainString': 'plain', 'o2String': 'o2', 'plainInt32': 10, 'o1Int32': 5 }",
        ...
        //            Assert.Throws<InvalidOperationException>(() => InfluxDbLineProtocolFormatter.Default.Format(timestamp));
        //        }
        ...
        //        {
        //            var json = InfluxDbLineProtocolFormatter.Default.Format(
        ...
        //            Assert.Throws<InvalidOperationException>(() => InfluxDbLineProtocolFormatter.Default.Format(duration));
        //        }
        ...
        //            AssertJson("{ 'durationField': '0s' }", InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }
        ...
        //                        "f",
        //                        Value.ForStruct(
        //                            new Struct { Fields = { { "nested", Value.ForString("value") } } }
        //                        )
        //                    }
        //                }
        //            };
        ...
        //            Assert.Throws<InvalidOperationException>(() => InfluxDbLineProtocolFormatter.Default.Format(mask));
        //        }
        ...
        //            var message = new TestWellKnownTypes
        //            {
        //                FieldMaskField = new FieldMask { Paths = { "user.display_name", "photo" } }
        //            };
        //            AssertJson(
        ...
        //            AssertJson("{ 'fileName': 'foo.proto' }", InfluxDbLineProtocolFormatter.Default.Format(message));
        //        }
        ...
        //        {
        //            var formatter = new InfluxDbLineProtocolFormatter(
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithTypeRegistry(
        ...
        //            AssertJson(
        //                "{ '@type': 'type.googleapis.com/protobuf_unittest3.TestAllTypes', 'singleInt32': 10, 'singleNestedMessage': { 'bb': 20 } }",
        //                formatter.Format(any)
        //            );
        //        }
        ...
        //            AssertJson(
        //                "{ '@type': 'foo.bar/baz/protobuf_unittest3.TestAllTypes', 'singleInt32': 10 }",
        //                formatter.Format(any)
        //            );
        //        }
        ...
        //                TestWellKnownTypes.Descriptor,
        //                TestAllTypes.Descriptor
        //            );
        //            var formatter = new InfluxDbLineProtocolFormatter(
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithTypeRegistry(registry)
        //            );
        ...
        //            AssertJson(
        //                "{ 'anyField': { '@type': 'type.googleapis.com/google.protobuf.Any', 'value': { '@type': 'type.googleapis.com/protobuf_unittest3.TestAllTypes', 'singleInt32': 20 } } }",
        //                formatter.Format(message)
        //            );
        //        }
        ...
        //            var message = new TestAllTypes();
        //            var any = Any.Pack(message);
        //            Assert.Throws<InvalidOperationException>(() => InfluxDbLineProtocolFormatter.Default.Format(any));
        //        }
        ...
        //                .Accessor.SetValue(populated, value);
        //            Assert.AreEqual(expectedJson, InfluxDbLineProtocolFormatter.Default.Format(populated));
        //        }
        ...
        //            var original = new Issue11987Message
        //            {
        //                A = 10,
        //                B = 20,
        //                C = 30
        //            };
        //            var json = InfluxDbLineProtocolFormatter.Default.Format(original);
        ...
        //            AssertWriteValue(
        //                value,
        //                "{ 'single_int32': 100, 'single_int64': '3210987654321' }",
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithPreserveProtoFieldNames(true)
        //            );
        //        }
        ...
        //            AssertWriteValue(value, "{}", InfluxDbLineProtocolFormatter.Settings.Default.WithIndentation());
        //        }
        ...
        //                {
        //                    Payload = new TestAllTypes { SingleString = "single field", },
        //                },
        //                RepeatedChild =
        //                {
        //                    new NestedTestAllTypes
        //                    {
        //                        Payload = new TestAllTypes
        //                        {
        ...
        //                    new NestedTestAllTypes
        //                    {
        //                        Payload = new TestAllTypes { SingleString = "child 2" }
        //                    },
        //                },
        //            };
        ...
        //  ]
        //}";
        //            AssertWriteValue(value, expectedJson, InfluxDbLineProtocolFormatter.Settings.Default.WithIndentation());
        //        }
        ...
        //            {
        //                Fields = { { "structField1", Value.ForString("structFieldValue1") } }
        //            };
        ...
        //        {
        //            var value = new TestAllTypes { SingleInt32 = 100, SingleInt64 = 3210987654321L };
        //            var formatter = new InfluxDbLineProtocolFormatter(InfluxDbLineProtocolFormatter.Settings.Default.WithIndentation());
        ...
        //                    {
        //                        1,
        //                        new ForeignMessage { C = 1 }
        //                    },
        //                    {
        //                        2,
        //                        new ForeignMessage { C = 2 }
        //                    },
        //                },
        //            };
        ...
        //                value,
        //                "[\n  1,\n  2,\n  3\n]",
        //                InfluxDbLineProtocolFormatter.Settings.Default.WithIndentation()
        //            );
        //        }
        ...
        //        private static void AssertWriteValue(
        //            object value,
        //            string expectedJson,
        //            InfluxDbLineProtocolFormatter.Settings settings = null
        //        )
        //        {
        //            var writer = new StringWriter { NewLine = "\n" };
        //            new InfluxDbLineProtocolFormatter(settings ?? InfluxDbLineProtocolFormatter.Settings.Default).WriteValue(writer, value);
        //            string actual = writer.ToString();
        //            AssertJson(expectedJson, actual);
        //        }

        /// <summary>
        /// Checks that the actual line protocol is the same as the expected line protocol
        /// </summary>
        /// <remarks>
        ...
        private static void AssertJson(string expectedLineProtocol, string actualLineProtocol)
        {
            var expectedJson = expectedLineProtocol.Replace("\r\n", "\n").TrimStart();
            Assert.AreEqual(expectedJson, actualLineProtocol.Replace("\r\n", "\n"));
        }
    }
}
